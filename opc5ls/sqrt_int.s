...
sqrt:
        PUSH   (r13)       # save return address on stack
        PUSH   (r12)       # save global registers and results pointer on stack
        PUSH   (r11)       # save global registers and results pointer on stack
        PUSH   (r10)       # save global registers and results pointer on stack
        PUSH   (r2)        # save global registers and results pointer on stack
...
sqrt_next2:
        ...
        POP     (r6)            # Pop results pointer off the stack
        sto     r3,r6,0         # save results, root first ..
        sto     r4,r6,1
        sto     r1,r6,2         # .. then remainder
        sto     r2,r6,3
        POP     (r10)         # restore all other registers
        POP     (r11)
        POP     (r12)
        POP     (r13)
